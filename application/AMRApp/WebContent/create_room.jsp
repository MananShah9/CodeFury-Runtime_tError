...
<body onload="validateCheckboxes()">
			            ...
			            <div class="card-body p-4">
			              <form  method="post" action="AdminCreateRoom" >
			                ...
			                <div class="form-outline mb-4">
			                  ...
			                  <input type="number" id="seatingcapacity" name="seatingcapacity" class="form-control form-control-lg"  min="1" required />
			                </div>
			               ...
			               <div class="form-check d-flex  mb-2">
			                <input class="form-check-input me-2" type="checkbox" value="Projector" id="projector" name="amenities" onclick="validateCheckboxes()"/>
			                    <label class="form-check-label" name="amenities" for="projector">Projector</label>
			                </div>
			                <div class="form-check d-flex  mb-2">
			                	<input class="form-check-input me-2" type="checkbox" value="WiFi Connection" id="wificonnection" name="amenities" onclick="validateCheckboxes()"/>
			                    <label class="form-check-label" name="amenities" for="wificonnection">WiFi Connection</label>
			                </div>
			                 <div class="form-check d-flex mb-2">
			                	<input class="form-check-input me-2" type="checkbox" value="Conference call facility" id="conferencecallfacility" name="amenities" onclick="validateCheckboxes()"/>
			                    <label class="form-check-label" name="amenities" for="conferencecallfacility">Conference Call Facility</label>
			                </div>
			                <div class="form-check d-flex  mb-2">
			                	<input class="form-check-input me-2" type="checkbox" value="Whiteboard" id="whiteboard" name="amenities" onclick="validateCheckboxes()"/>
			                    <label class="form-check-label" name="amenities" for="whiteboard">Whiteboard</label>
			                </div>
			                <div class="form-check d-flex  mb-2">
			                	<input class="form-check-input me-2" type="checkbox" value=" Water dispenser" id="waterdispenser" name="amenities" onclick="validateCheckboxes()"/>
			                    <label class="form-check-label" name="amenities" for="waterdispenser">Water Dispenser</label>
			                </div>
			                <div class="form-check d-flex  mb-2">
			                	<input class="form-check-input me-2" type="checkbox" value="TV" id="tv"name="amenities" onclick="validateCheckboxes()"/>
			                    <label class="form-check-label" name="amenities" for="tv">TV</label>
			                </div>
			                <div class="form-check d-flex  mb-4">
			                	<input class="form-check-input me-2" type="checkbox" value="Coffee Machine" id="coffeemachine" name="amenities" onclick="validateCheckboxes()"/>
			                    <label class="form-check-label" name="amenities" for="coffeemachine">Coffee Machine</label>
			                    
			                    <div style="margin-left:45%;">
			                    	 <button type="submit" class="btn btn-success ml-3 mb-3" id="submitButton">SAVE</button>
